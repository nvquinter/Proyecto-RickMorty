...
export default function Home (){
    return(
        ...
        <header className="container-header d-flex flex-column justify-content-center aling-items-center ">
            <h1 className="row justify-content-center">Proyect Rick & Morty</h1>
            <h2 className="text-center p-2">Welcome to Rick & Morty Proyect!</h2>
